...
export const ABIS = {
  ...
  "ChainlinkPriceOracle": [
    ...
    {
      "type": "error",
      "name": "ChainlinkPriceOracle__InvalidPrice",
      "inputs": []
    }
  ],
  "PositionManager": [
    ...
    {
      "type": "error",
      "name": "PositionManager__PositionIsSafe",
      "inputs": []
    }
  ],
  "LendingPool": [
    ...
    {
      "type": "error",
      "name": "LendingPool__PositionIsSafe",
      "inputs": []
    },
    {
      "type": "error",
  ...
  "ReactiveLiquidationEngine": [
    ...
    {
      "type": "event",
      "name": "DebugLiquidationTriggered",
      "inputs": [
        {
          "name": "user",
          "type": "address",
    ...
    {
      "type": "error",
      "name": "ReactiveLiquidationEngine__NotAuthorized",
      "inputs": []
    },
    {
      "type": "error",
